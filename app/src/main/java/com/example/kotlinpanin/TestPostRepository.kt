...
class TestPostRepository : PostRepository {
    override fun getPosts(): List<Post> {
        ...
        posts.add(videoPost)
        posts.add(Post("User Four", R.mipmap.test_img_four, LocalDateTime(2020, 5, 5, 12, 6, 0, 0), PostType.REPOST, textPost,"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod",null, null,null, 3, 11, 2))
