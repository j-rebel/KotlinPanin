...
class TestPostRepository : PostRepository {
        override fun getPosts(): List<Post> {
            ...
            val textPost = Post(
                    ...
                    LocalDateTime(2020, 5, 5, 15, 9, 0, 0),
                    PostType.TEXT,
                    null,
            ...
            val videoPost = Post(
                    ...
                    LocalDateTime(2020, 5, 5, 13, 7, 0, 0),
                    PostType.VIDEO,
                    null,
            ...
            val eventPost = Post(
                    ...
                    LocalDateTime(2020, 5, 5, 14, 8, 0, 0),
                    PostType.EVENT,
                    null,
            ...
            val rePost = Post(
                    ...
                    LocalDateTime(2020, 5, 5, 12, 6, 0, 0),
                    PostType.REPOST,
                    videoPost,
            ...
            val adPost = Post(
                    ...
                    LocalDateTime(2020, 5, 5, 11, 5, 0, 0),
                    PostType.AD,
                    null,
                    "Рекламный пост",
                    null,
